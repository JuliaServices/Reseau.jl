...
Core.eval(TCP, quote
    function compiler_repro_wait_arg_kwargs_elseif(
...
Base.return_types(Core.kwcall, Tuple{KW, typeof(TCP.compiler_repro_wait_arg_kwargs_elseif), TCP.SocketAddrV4})
