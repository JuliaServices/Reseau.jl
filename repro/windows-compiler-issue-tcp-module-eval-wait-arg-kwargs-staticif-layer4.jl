...
Core.eval(TCP, quote
    function compiler_repro_wait_arg_kwargs_staticif(
...
Base.return_types(Core.kwcall, Tuple{KW, typeof(TCP.compiler_repro_wait_arg_kwargs_staticif), TCP.SocketAddrV4})
