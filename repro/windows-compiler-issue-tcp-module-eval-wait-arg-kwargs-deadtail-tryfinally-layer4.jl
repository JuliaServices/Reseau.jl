...
Core.eval(TCP, quote
    function compiler_repro_wait_arg_kwargs_deadtail_tryfinally(
...
Base.return_types(Core.kwcall, Tuple{KW, typeof(TCP.compiler_repro_wait_arg_kwargs_deadtail_tryfinally), TCP.SocketAddrV4})
