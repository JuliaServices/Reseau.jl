...
Core.eval(TCP, quote
    function compiler_repro_wait_arg_deadtail_emptytryfinally(remote_addr::SocketAddr)::FD
...
Base.return_types(TCP.compiler_repro_wait_arg_deadtail_emptytryfinally, Tuple{TCP.SocketAddrV4})
