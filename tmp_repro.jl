...
on_accept = Reseau.ChannelCallable((err, new_sock) -> begin
    ...
    Sockets.socket_subscribe_to_readable_events(new_sock, Reseau.EventCallable(err -> begin
        read_done[] = true
...
Sockets.socket_connect(client_socket, Sockets.SocketConnectOptions(Sockets.SocketEndpoint("127.0.0.1", port), event_loop=el_val, on_connection_result=on_conn))
